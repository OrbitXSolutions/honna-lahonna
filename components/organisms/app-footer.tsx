...
export function AppFooter({ className, ...props }: Props) {
  return (
    <footer {...props} className={"relative"}>
      <GridBackground>
        <div className="container mx-auto p-3 md:p-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 sm:space-x-16 space-y-10 py-3">
            <FooterBio />
            <FooterSiteLinks />
            <FooterContact />
          </div>
