...
import { Home, Users, Briefcase, BookOpen, HelpCircle, Phone, UserCircle } from 'lucide-react'
                        ...
                        <div className="p-4 sm:p-6 flex-shrink-0">
                          ...
                          >
                            ...
                            {user.email?.split('@')[0]}
                                ...
                                >
                                    <Link href="/provider-registration" onClick={handleLinkClick}>
                                        {'تسجيل كمزود الخدمة'}
                                    </Link>
                    ...
                    >
                        <p className="text-center text-xs sm:text-sm text-gray-600">
                            © {new Date().getFullYear()} {
                                'جميع الحقوق محفوظة لمؤسسة هن لهن'
                            }.
                            {' '}
                            {'تطوير: '}
                        </p>
